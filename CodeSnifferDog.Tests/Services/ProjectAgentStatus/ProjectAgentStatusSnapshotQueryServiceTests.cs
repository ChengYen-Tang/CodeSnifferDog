...
[TestClass]
public sealed class ProjectAgentStatusSnapshotQueryServiceTests
{
    ...
    {
        ProjectAgentStatusSnapshotQueryService service = new(CreateDbContextFactory());

        ProjectAgentStatusSnapshotReadModel? snapshot = await service.GetSnapshotAsync(
            Guid.NewGuid(),
    ...
    public async Task GetSnapshotAsync_ResolvesSelectedAgentAndOrdersTimeline()
    {
        ...
        ProjectAgentStatusSnapshotQueryService service = new(dbContextFactory);
        ...
        ProjectAgentStatusSnapshotAgentRow loadedAgent = snapshot.Groups.Single().Agents.Single();
    ...
    public async Task GetAgentHistoryAsync_RequiresAgentToBelongToProject()
    {
        ...
        ProjectAgentHistorySnapshotReadModel? history = await service.GetAgentHistoryAsync(
            otherProjectId,
            agentId,
            TestContext.CancellationToken);
