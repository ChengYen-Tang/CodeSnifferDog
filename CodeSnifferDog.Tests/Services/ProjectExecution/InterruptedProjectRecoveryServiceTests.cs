...
[TestClass]
public sealed class InterruptedProjectRecoveryServiceTests
{
    [TestMethod]
    public async Task RecoverAsync_WhenReviewingProjectHasExtractedRepository_RequeuesProject()
    {
        ...
        InterruptedProjectRecoveryService service = CreateService(services, storagePaths);
    ...
    private static InterruptedProjectRecoveryService CreateService(
