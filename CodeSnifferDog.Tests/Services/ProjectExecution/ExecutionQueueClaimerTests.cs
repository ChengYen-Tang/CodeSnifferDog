...
[TestClass]
public sealed class ExecutionQueueClaimerTests
{
    [TestMethod]
    ...
    private static ExecutionQueueClaimer CreateClaimer(ServiceProvider services, TestLeaseRegistry leaseRegistry) =>
        new(
    ...
    private sealed class TestLeaseRegistry : IProjectExecutionLeaseRegistry
    {
        ...
        public ProjectExecutionLease Register(Guid projectId, CancellationToken cancellationToken)
        {
            ...
            return new ProjectExecutionLease(projectId, cancellationToken, DisposedProjectIds.Add);
        }
