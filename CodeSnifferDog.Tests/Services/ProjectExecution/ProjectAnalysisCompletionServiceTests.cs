...
[TestClass]
public sealed class ProjectAnalysisCompletionServiceTests
{
    ...
    public async Task CompleteAnalysisAsync_NoFindingsAndDegradedFlow_ThrowsAndClearsReports()
    {
        ...
        ProjectAnalysisCompletionService service = CreateService(services);
    ...
    private static ProjectAnalysisCompletionService CreateService(ServiceProvider services) =>
        new(services.GetRequiredService<IProjectReportService>());
