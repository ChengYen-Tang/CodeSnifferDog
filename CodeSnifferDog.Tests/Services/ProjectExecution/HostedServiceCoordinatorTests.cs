...
public sealed class HostedServiceCoordinatorTests
{
    ...
    public async Task StartAsync_WhenNotReady_RunsRecoveryBeforeReadiness_AndDoesNotClaim()
    {
        ...
        TestReadinessGate readinessGate = new(calls, new Result(false, "not ready"));
    ...
    private sealed class TestRecoveryService(List<string> calls) : IService
    {
    ...
    private sealed class TestQueueLock(List<string> calls) : IQueueLock
    {
