...
public sealed class RuntimeFactoryTests
{
    ...
    public async Task Create_RuntimeHandlerPersistsEventsAndPublishesLiveUpdates()
    {
        ...
        RuntimeFactory factory = new(new RuntimeComponentsFactory(
            dbContextFactory,
            liveUpdateNotifier,
            new ProjectionMapper(new ProjectStatusMapper()),
            new TimelinePersistenceService()));
        RuntimeContext runtime = factory.Create(projectId);
    ...
    {
        private readonly ProjectionMapper _inner = new(new ProjectStatusMapper());
    ...
    private sealed class CapturingRuntimeComponentsFactory : IRuntimeComponentsFactory
    {
        public TestEventHandler EventHandler { get; } = new();
        ...
        public RuntimeComponents Create(Guid projectId)
        {
            ...
            return new RuntimeComponents(EventHandler);
        }
    }
