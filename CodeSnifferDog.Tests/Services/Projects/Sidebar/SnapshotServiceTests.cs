...
public sealed class SnapshotServiceTests
{
    ...
    public async Task GetSnapshotAsync_ReturnsFixedGroupOrderAndSortedProjects()
    {
        ...
        SnapshotService service = CreateService(dbContextFactory);
    ...
    public async Task GetSnapshotAsync_UsesProjectionMapperForSidebarProjects()
    {
        ...
        SnapshotService service = CreateService(dbContextFactory, mapper);
    ...
    private static SnapshotService CreateService(
        ...
        new(
            new QueryService(dbContextFactory, new ProjectStatusMapper()),
            mapper ?? CreateMapper());
}
