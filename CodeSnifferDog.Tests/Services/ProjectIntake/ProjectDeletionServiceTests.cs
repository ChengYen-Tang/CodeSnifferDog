...
public sealed class ProjectDeletionServiceTests
{
    ...
    public async Task DeleteAsync_RemovesProjectAndArtifacts()
    {
        ...
        ProjectDeletionService service = new(dbContextFactory, storagePaths);
    ...
    {
        ProjectDeletionService service = new(CreateDbContextFactory(), new ProjectTemporaryStoragePaths());
    ...
    public async Task DeleteAsync_WhenProjectIsReviewing_ThrowsOriginalException()
    {
        ...
        ProjectDeletionService service = new(dbContextFactory, new ProjectTemporaryStoragePaths());
