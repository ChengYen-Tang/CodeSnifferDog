...
public sealed class WorkflowTests
{
    ...
    public async Task RunAsync_RunsProjectPlanWorkflow_ForEachScannedProject()
    {
        ...
        Result<PreparationWorkflowResult> result =
            await workflow.RunAsync(TestRepositoryPaths.RootPath, TestContext.CancellationToken);
    ...
    private static ProjectPlanWorkflowResult CreateProjectPlanResult(
        ...
        IReadOnlyList<StoredTaskItem>? taskItems = null)
        =>
        new()
        {
