...
[TestClass]
public sealed class ProjectPlanWorkflowMessageBuilderTests
{
    [TestMethod]
    public void CreatePlanMessages_UsesUserRolePrefixAndSerializedScanProject()
    {
        ProjectPlanWorkflowMessageTemplates templates = new(new PromptAssetReader());
        ProjectPlanWorkflowMessageBuilder builder = new(templates);
