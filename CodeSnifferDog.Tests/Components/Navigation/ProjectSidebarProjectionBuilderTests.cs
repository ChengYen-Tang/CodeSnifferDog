...
[TestClass]
public sealed class ProjectSidebarProjectionBuilderTests
{
    [TestMethod]
    public void CreatesGroupsWithIconsExpansionAndProjectMetadata()
    {
        ...
        ProjectSidebarState state = CreateState(
            reviewingProjectId,
        ...
        IReadOnlyList<ProjectGroup> groups = ProjectSidebarProjectionBuilder.CreateGroups(state);
    ...
    private static ProjectSidebarState CreateState(Guid? selectedProjectId, params ProjectSidebarGroupDto[] groups)
    {
        ProjectSidebarState state = ProjectSidebarState.CreateEmpty();
        state.ApplySnapshot(
