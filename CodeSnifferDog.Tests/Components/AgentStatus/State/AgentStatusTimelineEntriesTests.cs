...
[TestClass]
public sealed class AgentStatusTimelineEntriesTests
{
    ...
    public void UpsertInsertsEntryBySequenceAndOccurredAt()
    {
        ...
        IReadOnlyList<ProjectAgentTimelineEntryDto> result =
            AgentStatusTimelineEntries.Upsert(timelineEntries, CreateEntry(2, 20));
    ...
    public void UpsertReplacesExistingEntryAndRepositionsWhenOrderChanges()
    {
        ...
        IReadOnlyList<ProjectAgentTimelineEntryDto> result =
            AgentStatusTimelineEntries.Upsert(timelineEntries, CreateEntry(4, 40, replacedEntryId, "new"));
    ...
    public void UpsertPreservesExistingPositionWhenOrderKeyDoesNotChange()
    {
        ...
        IReadOnlyList<ProjectAgentTimelineEntryDto> result =
            AgentStatusTimelineEntries.Upsert(timelineEntries, CreateEntry(2, 20, replacedEntryId, "new"));
    ...
    public void UpsertOrdersDuplicateSequenceByOccurredAt()
    {
        ...
        IReadOnlyList<ProjectAgentTimelineEntryDto> result =
            AgentStatusTimelineEntries.Upsert(
                timelineEntries,
    ...
    public void RemoveReturnsRemainingEntriesAndPreservesNoOpShape()
    {
        ...
        IReadOnlyList<ProjectAgentTimelineEntryDto> removed =
            AgentStatusTimelineEntries.Remove(timelineEntries, new HashSet<Guid> { removedEntryId });
        IReadOnlyList<ProjectAgentTimelineEntryDto> noOp =
            AgentStatusTimelineEntries.Remove(timelineEntries, new HashSet<Guid> { Guid.Parse("73000000-0000-0000-0000-000000000099") });
    ...
    public void GetLatestSequenceTracksAddReplaceAndRemoveResults()
    {
        ...
        Assert.AreEqual(5, AgentStatusTimelineEntries.GetLatestSequence(timelineEntries));

        IReadOnlyList<ProjectAgentTimelineEntryDto> lowered =
            AgentStatusTimelineEntries.Upsert(timelineEntries, CreateEntry(2, 20, replacedEntryId));
        Assert.AreEqual(2, AgentStatusTimelineEntries.GetLatestSequence(lowered));

        IReadOnlyList<ProjectAgentTimelineEntryDto> raised =
            AgentStatusTimelineEntries.Upsert(lowered, CreateEntry(9, 90));
        Assert.AreEqual(9, AgentStatusTimelineEntries.GetLatestSequence(raised));

        IReadOnlyList<ProjectAgentTimelineEntryDto> removed =
            AgentStatusTimelineEntries.Remove(raised, new HashSet<Guid>(raised.Select(entry => entry.TimelineEntryId)));
        Assert.AreEqual(0, AgentStatusTimelineEntries.GetLatestSequence(removed));
    }
    ...
    public void LargeTimelineUpsertAndRemoveKeepExpectedStructure()
    {
        ...
        IReadOnlyList<ProjectAgentTimelineEntryDto> withInserted =
            AgentStatusTimelineEntries.Upsert(timelineEntries, CreateEntry(501, 501));
        IReadOnlyList<ProjectAgentTimelineEntryDto> withRemoved =
            AgentStatusTimelineEntries.Remove(withInserted, new HashSet<Guid>
            {
