...
internal sealed class ProjectPlanWorkflowMessageBuilder(ProjectPlanWorkflowMessageTemplates messageTemplates)
{
    private readonly ProjectPlanWorkflowMessageTemplates _messageTemplates = messageTemplates;
