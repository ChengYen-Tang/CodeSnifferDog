...
internal sealed class RuleReportWorkflowMessageBuilder(RuleReportWorkflowMessageTemplates messageTemplates)
{
    private readonly RuleReportWorkflowMessageTemplates _messageTemplates = messageTemplates;
