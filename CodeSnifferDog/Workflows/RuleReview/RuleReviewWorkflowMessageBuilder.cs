...
internal sealed class RuleReviewWorkflowMessageBuilder(RuleReviewWorkflowMessageTemplates messageTemplates)
{
    private readonly RuleReviewWorkflowMessageTemplates _messageTemplates = messageTemplates;
