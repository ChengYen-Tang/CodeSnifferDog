...
public sealed class OperationalContextMessageShrinker
{
        ...
        OperationalContextCompactionOptions options)
    {
        ...
        if (!options.EnableMicroCompaction)
            return OperationalContextMessageShrinkResult.NoChange(messages);
        ...
        OperationalContextCompactionOptions options)
    {
        ...
        return new OperationalContextMessageShrinkResult
        {
    ...
    private static OperationalContextMessageShrinkResult RewriteMessages(
        IReadOnlyList<ChatMessage> messages,
        ...
        int freedEstimatedTokens)
    {
        ...
        clone.AdditionalProperties = original.AdditionalProperties?.Count > 0
            ...
            : [];
        clone.AdditionalProperties[OperationalContextCompactionArtifactMetadata.ShrinkOperationKey] = shrinkOperation;
        clone.AdditionalProperties[OperationalContextCompactionArtifactMetadata.ShrunkToolResultCountKey] = shrunkToolResultCount;
        clone.AdditionalProperties[OperationalContextCompactionArtifactMetadata.FreedEstimatedTokensKey] = freedEstimatedTokens;
