...
internal sealed class AgentStatusSnapshotLookup
{
    private static readonly AgentStatusSnapshotLookup Empty = new(
    ...
    private AgentStatusSnapshotLookup(
    ...
    public static AgentStatusSnapshotLookup From(IReadOnlyList<ProjectAgentGroupSnapshotDto>? groups)
    {
        ...
        return new AgentStatusSnapshotLookup(groupIndexesById, agentLocationsById, firstAgentId);
    }
