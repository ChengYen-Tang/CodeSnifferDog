...
internal sealed class ProjectReviewWorkflowRunnerFactory(
    ILoggerFactory loggerFactory,
    IServiceProvider serviceProvider) : IProjectReviewWorkflowRunnerFactory
{
        ...
        IAgentEventBus agentEventBus)
    {
        ...
        OperationalContextAgentCompactionOptionsFactory compactionOptionsFactory = new(
            promptAssetReader,
        ...
        return new ProjectReviewWorkflowRunners
        {
            ScanWorkflowRunner = (repositoryRootPath, cancellationToken) =>
                RunScanWorkflowAsync(chatClient, repositoryRootPath, compactionSettings.Scan, compactionOptionsFactory, promptAssetReader, agentEventBus, executionOptions, cancellationToken),
            ProjectPlanWorkflowRunner = (repositoryRootPath, scanProject, cancellationToken) =>
                RunProjectPlanWorkflowAsync(chatClient, repositoryRootPath, scanProject, compactionSettings.ProjectPlan, compactionOptionsFactory, promptAssetReader, agentEventBus, executionOptions, cancellationToken),
